...
#     # WITH THE HELP OF PRETTIFY METHOD WE CAN SEE HTML SCRAPPED CODE IN BEAUTIFUL FORMAT..
#     # pdf.write(10,soup.prettify())

#     # WITH THE HELP OF FIND FUNCTION WE CAN EASILY ABEL TO FIND ELEMENTS OF HTML PAGE..
#     # AND FIND METHOD GIVES ONLY FIRST OCCURENCE..
#     # tags = soup.find('h1')
#     # pdf.write(10,tags)

#     # FOR OVERCOME FIND METHOD PROBLEM WE HAVE TO GO WITH FIND_ALL METHOD WHO GIVES ALL DFINED ELEMENTS OF HTML PAGE 
#     # tags = soup.find_all('h1')
#     # pdf.write(10,tags)
#     # pdf.write(10,len(tags))

#     # RETURN TEXT OF HTML TAGS WITH THE HELP OF text METHOD..
#     # hello_world = soup.find_all('h1')
#     # for x in hello_world:
#     #     pdf.write(10,x.text)

#     #  
#     card_content = soup.find_all('div',class_ = 'card')
#     for card in card_content:
#         # pdf.write(10,card) # FROM THIS WE GOT WHOLE CARD CLASSES 
#         # pdf.write(10,card.h5.text) # BUT FROM THIS WE GET SPECIFIC TAGS WHOS CLASS ARE CARD
#         # pdf.write(10,card.a.text) # BUT FROM THIS WE GET SPECIFIC TAGS WHOS CLASS ARE CARD
#         cardHead = card.h5.text
#         cardA = card.a.text
#         pdf.write(10,cardHead)
#         pdf.write(10,cardA)
